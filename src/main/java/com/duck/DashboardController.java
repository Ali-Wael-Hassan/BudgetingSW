...
public class DashboardController implements PropertyChangeListener {
    ...
    private void refreshDashboard() {
        ...
        if (spendingAmountLabel != null) spendingAmountLabel.setText("$0");
        if (spendingLimitLabel != null) spendingLimitLabel.setText("/ $0");
    ...
    private void loadMonthlySpending() {
        ...
        List<Transaction> expenses = transactionManager.getTransactions(expenseConfig);
        ...
        if (spendingAmountLabel != null) spendingAmountLabel.setText(String.format("$%,.0f", totalExpense));
        if (spendingLimitLabel != null) spendingLimitLabel.setText(String.format("/ $%,.0f", totalBudget));
    ...
    private HBox createGoalCard(SavingGoal goal) {
        ...
        Label amountLabel = new Label(String.format("$%,.0f / $%,.0f", goal.getCurrentAmount(), goal.getTargetAmount()));
